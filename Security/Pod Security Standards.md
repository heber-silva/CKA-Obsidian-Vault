...
|Host Ports|HostPorts should be disallowed entirely (recommended) or restricted to a known list<br><br>**Restricted Fields**<br><br>- `spec.containers[*].ports[*].hostPort`<br>- `spec.initContainers[*].ports[*].hostPort`<br>- `spec.ephemeralContainers[*].ports[*].hostPort`<br><br>**Allowed Values**<br><br>- Undefined/nil<br>- Known list (not supported by the built-in [Pod Security Admission controller](https://kubernetes.io/docs/concepts/security/pod-security-admission/))<br>- `0`|
